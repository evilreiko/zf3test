<?php
// this class demonstrate how to get the db connection set in the config and used in this controller WITHOUT custom controller factory
...
class MycustomcontxController extends AbstractActionController
{
...
//        $result = $stmt->execute();// to execute the statment. returned: Zend\Db\Adapter\Driver\Pdo\Result
    ...
    public function mycustomactxAction()
    {
        return new ViewModel();      
    }
}
